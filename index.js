...
const url2 = '&app_id=634fffba&app_key=7459dee67e2f7bc6a205709a8610fb81'


document.body.classList.add('container');
let title = createDomElement('h1', document.body, [['style', 'text-align:center; color:#FF9933']], [['textContent', 'RECIPE SEARCH']])
...
createDomElement('label', ingredientGroup, [['for', 'ingredient']], [['innerHTML', 'Enter ingredient to search for:&nbsp;&nbsp;']]);
createDomElement('input', ingredientGroup, [['type', 'text'], ['id', 'ingredient'], ['class', 'mr-2']]);
